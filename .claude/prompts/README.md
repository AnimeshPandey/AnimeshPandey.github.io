...
Paste into Cursor or Claude when implementing changes on [AnimeshPandey.github.io](https://github.com/AnimeshPandey/AnimeshPandey.github.io).

| Prompt | Use when |
|--------|----------|
| [portfolio-architecture-prompt.md](portfolio-architecture-prompt.md) | Repo layout, file roles, conventions |
| [portfolio-layout-responsive-themes-prompt.md](portfolio-layout-responsive-themes-prompt.md) | Breakpoints, spacing, multi-theme system |
| [portfolio-design-system-tokens-prompt.md](portfolio-design-system-tokens-prompt.md) | Tokens, component CSS, `constants.js` |
| [portfolio-premium-ux-sections-prompt.md](portfolio-premium-ux-sections-prompt.md) | Header, resume modal, section polish |
| [portfolio-i18n-localization-prompt.md](portfolio-i18n-localization-prompt.md) | Locales, `data-i18n`, RTL |
