...
[![Eleventy](https://img.shields.io/badge/Eleventy-3-1B1B1B?style=flat-square&logo=eleventy)](https://www.11ty.dev/)
...
| Offline | Service worker cache-first static assets; HTML network-first |
